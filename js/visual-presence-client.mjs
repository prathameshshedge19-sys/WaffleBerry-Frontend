...
export const visualError = (error) => {
  ...
  if (code === "visual_cleanup_pending") return "Previous previews are still being securely removed. Your photo is saved. Try Regenerate again shortly.";
  return ({ 401: "Please sign in again.", 403: "Face recreation is managed by the Legacy owner.",
    ...
    429: "Face preparation is temporarily busy. Your photo is saved. Please retry shortly." })[error?.status] || "Face recreation is temporarily unavailable. Your memories and voice conversations are unaffected.";
};
